  ...
  .curso-main-container.pb-3
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-4
      ...
      .titulo-sexto.color-acento-contenido.offset-1(data-aos="zoom-in")
        h5 Figura 10.
        span  #[i Planificación turística]
        ...
        .col-lg-7
                ul.lista-ul
                  li
                    ...
                    | La existencia de un grupo humano con capacidad para actuar y tomar decisiones, buscando influir en el cambio y mejorar las condiciones de vida de sus integrantes.
                  li
                    i.fas.fa-angle-right
                    | El colectivo presenta una conciencia de pertenencia, evidenciando un grado de integración subjetiva en una identidad comunitaria compartida.
                  li
                    i.fas.fa-angle-right
      ...
      .row.justify-content-center.align-items-center.mb-4
        .col-lg-7
          ...
          LineaTiempoD.color-acento-botones
            ...
            p.text-small(numero="2" titulo="Confianza y respeto") Los procesos comunitarios necesitan establecer vínculos de confianza y reciprocidad, así como reconocer y valorar los roles de los demás.
            p.text-small(numero="3" titulo="Deliberación y transparencia") La participación comunitaria no se basa en dilemas simples; requiere una deliberación de calidad y un sólido fundamento argumental para construir proyectos y alternativas.
            p.text-small(numero="4" titulo="Conflicto e innovación") Se propone gestionar el conflicto, a través del diálogo como principio básico y ver las contradicciones como oportunidades para la creatividad e innovación social.
            p.text-small(numero="5" titulo="Complejidad y articulación de redes") La construcción de respuestas requiere la colaboración de actores y redes interdependientes, superando monopolios y jerarquías. Es fundamental crear espacios plurales de decisión y alianzas, reconociendo capacidades y límites.
        ...
        .col-lg-7
          ...
          .col-lg-7
                ul.lista-ul
                  li
                    i.fas.fa-angle-right
                    | Retroalimentar y guiar la estrategia para maximizar el impacto de los objetivos y la visión de desarrollo. 
                  li
                    i.fas.fa-angle-right
